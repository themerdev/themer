        ...
        const svg = `
          ...
          >
            <defs>
              ...
              >
                <path
                  d="${getOctagonPathData(size.s)}"
                  stroke="${colorSet.colors.shade1}"
                  stroke-width="1"
                  fill="none"
                />
              </pattern>
              ...
              >
                <path
                  d="${getOctagonPathData(size.s * 10)}"
                  stroke="${colorSet.colors.shade2}"
                  stroke-width="2"
                  fill="none"
                />
              </pattern>
              <radialGradient id="accent-bg">
                <stop
                  offset="25%"
                  stop-color="${colorSet.colors.shade0}"
                />
                <stop
                  offset="100%"
                  stop-color="${colorSet.colors.shade0}"
