...
const renderReadmeFile = (colorSets) => {
  ...
  return Promise.resolve({
    ...
    contents: Buffer.from(
      `Your personal ${themeOrThemes}, generated by the [VS Code template](https://github.com/mjswensen/themer/tree/main/cli/packages/themer-vscode) for [themer](https://github.com/mjswensen/themer).`,
    ),
  });
};
