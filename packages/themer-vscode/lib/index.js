...
const renderReadmeFile = colorSets => {
  ...
  return Promise.resolve({
    ...
    contents: Buffer.from(
      `Your personal ${themeOrThemes}, generated by the [VS Code template](https://github.com/mjswensen/themer/tree/master/packages/themer-vscode) for [themer](https://github.com/mjswensen/themer).`
    )
  });
};
